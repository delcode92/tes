...
from PyQt5.QtWidgets import (QTableWidget, QWidget, QVBoxLayout, QHBoxLayout, QFrame, QPushButton, QSizePolicy, QLabel, QStackedWidget)
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Top_Bar.setStyleSheet(u"background-color: rgb(35, 35, 35); border: 2px solid grey;")
        ...
        # inside top bar QFrame has frame_toggle QFrame
        ...
        # add toggle button to self.frame_toggle
...
"}")
        ...
        # create table here
        table = QTableWidget(self.page_1)
        ...
        lbl = QLabel()
        lbl.setText("test label")
        lbl.setAlignment(Qt.AlignCenter)
        lbl.setStyleSheet("background:#bada55;")        
        self.label_1.setStyleSheet("background:#badd55;")        

        self.verticalLayout_7.addWidget(lbl)
        self.verticalLayout_7.addWidget(table)
        # self.verticalLayout_7.addWidget(self.label_1)
        # self.verticalLayout_7.addWidget(QLabel("tetser"))
